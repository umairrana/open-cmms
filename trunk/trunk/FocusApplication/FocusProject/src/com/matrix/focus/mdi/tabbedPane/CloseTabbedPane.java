...
public class CloseTabbedPane extends JTabbedPane {
	...
	//private CloseTabProxyUI paneUI;
        ...
        public void addTab(String name,Component tab){
           ...
           /*
           if(super.indexOfTab(name) == -1){
                super.addTab(name,tab);
                super.setSelectedIndex(indexOfTab(name));
           }else{
                super.setSelectedIndex(indexOfTab(name));
           }
           */
...
//}
/*************************************************************************************************/
class CloseTabbedPaneEvent extends Event {
...
/**************************************************************************************************/
class CloseTabPaneEclipseUI extends CloseTabPaneUI {
...
class CloseTabPaneEnhancedUI extends CloseTabPaneUI {
    ...
    private static final Color transparent =Color.decode("#002EB8");//new Color(41,56,115) ;//new Color(0x184EB6);//0, 0, 0, 0);
    private static final Color nearBlack =new Color(0, 0, 0, 80); //new Color(235,235,235); 
    
    private static final Color lightBlue =Color.decode("#002EB8");//new Color(41,56,115); //Color.CYAN;//new Color(0x8CA9FF);//70, 150, 200, 50);
    
    private static final Color lightWhite = new Color(180,180,180);//new Color(150, 150, 150, 50);
    
    private static final Color selectedColor = Color.decode("#002EB8");//new Color(41,56,115);//new Color(15, 70, 180);
...
class CloseTabPaneUI extends BasicTabbedPaneUI {
	...
	public CloseTabPaneUI() {
		...
		try {
            closeImgI = ImageIO.read(getClass().getResource("images/cancel.png"));
		...
		//closeItem = new JMenuItem("Close");
                //closeItem.setFont(new Font("System",0,12));
...
/**************************************************************************************************/
class CloseTabProxyUI extends CloseTabPaneUI {
