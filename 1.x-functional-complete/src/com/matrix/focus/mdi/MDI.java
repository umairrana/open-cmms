...
import com.matrix.focus.log.GUIJobReport;
...
import com.matrix.focus.master.gui.GUIPartsMaster;
...
public class MDI extends JFrame implements ActionListener{
    ...
    private MMenu menuGeneral;
        ...
        private MMenuItem menuItemPart;
            private GUIPartsMaster guiPartsMaster;
    ...
    private MMenu menuWorkorders;
        ...
        public MMenuItem menuItemGUIJobReport;
            public GUIJobReport guiJobReport;
    ...
    public MDI(DBConnectionPool pool,String username){
        ...
        USERNAME = username;
        try{
            setTitle(TITLE + "  ..:: logged in as " + username + " to "+ connectionPool.DB_SERVER +" ::..");
    ...
    private void setGeneralMenu(){
        menuGeneral = new MMenu("General");
            ...
            if(Authorizer.isCapable(MDI.USERNAME,Authorizer.PARTS_INVENTORY,connectionPool.getConnection())){
                menuItemPart = new MMenuItem("Parts Master",ImageLibrary.MENU_PARTS);
    ...
    private void setWorkordersMenu(){
        ...
        //Adding Job Report menu item
        if(Authorizer.isCapable(MDI.USERNAME,Authorizer.JOB_CREATION,connectionPool.getConnection())){
            menuItemGUIJobReport = new MMenuItem("Job Report",ImageLibrary.MENU_PREVENTIVE_WORKORDER);
            menuItemGUIJobReport.addActionListener(this);
            menuWorkorders.add(menuItemGUIJobReport);
            items++;
        }
        if(items!=0){    
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(click==menuItemGUICustomer){
            ...
            loadingGUI();
            //if(guiPartsMaster==null){
                guiPartsMaster =  new GUIPartsMaster(connectionPool,this, messageBar);
            //}
            tabbedPane.addTab("Parts Master",guiPartsMaster);
            loadedGUI();
        }
        ...
        else if(click==menuItemGUIJobReport){
            loadingGUI();
            //if(guiJobReport==null){
                guiJobReport  = new GUIJobReport(connectionPool,this,messageBar);
            //}
            tabbedPane.addTab("Job Report",guiJobReport);
            loadedGUI();
        }
