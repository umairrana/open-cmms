...
public class PreventiveMaintenanceWorkOrder {
    ...
    public void save() throws Exception{
        ...
        String sql = "INSERT INTO preventive_maintenance_work_order (PM_Work_Order_ID, Division_ID, type, category, Created_Date, creater, regular_visit) VALUES(?, '0', ?, ?, NOW(),?,?)";
    ...
    public void update() throws Exception{
        ...
        stmt.setString(11,model); // nuwan
         stmt.setString(12,regularVisit); // nuwan
        stmt.setString(13,workorder_id);
        if(stmt.executeUpdate()!=1){
    ...
    private void read() throws Exception{
        ...
        if(rec.first()){ 
            ...
            regularVisit = rec.getString("regular_visit");
        }
        else{
